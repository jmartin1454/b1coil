...
b=r_0+big_delta/2 #outer radius in m
a=r_0-big_delta/2 #inner radius in m
...
o=gamma*big_delta
SE_ee=np.abs(e*(2*big_delta*mu_r**2+mu_r*(a*b*h*gamma**2-big_delta)+big_delta*k)*np.cosh(o)
             +e/gamma*(gamma**2*l+h*big_delta*mu_r*gamma**2+2*k*mu_r**2+mu_r+1)*np.sinh(o))
